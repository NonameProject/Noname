...
namespace CultureEngine {
    ...
    public class LocalizationResx {
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Рівень оплати за навчання та рівень на зарплати через N років після початку навчання.
        /// </summary>
        ...
        /// <summary>
        ///   Ищет локализованную строку, похожую на Сумарні витрати на освіту і сумарний заробіток потому N років після початку навчання.
        /// </summary>
